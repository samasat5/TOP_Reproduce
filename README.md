...
```bash
(TOP_Mujoco) 12345678@ppti-gpu-3 $ conda deactivate 
12345678@ppti-gpu-3 $ conda env create -f conda_environment_plot.yaml
```

```bash
(TOP_Plot) 12345678@ppti-gpu-3:~/TOP/mujoco$ python export_csv_plot
